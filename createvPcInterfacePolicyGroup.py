...
def create_vpc_interface_policy_group(parent_mo, group_name, **args):
    """Create a PC Interface Policy Group"""
    args = args['optional_args'] if 'optional_args' in args.keys() else args

    # Create mo
    infra_accbndlgrp = AccBndlGrp(parent_mo, ownerKey='', name=group_name, lagT='node')
    ...
    if is_valid_key(args, 'entity_profile'):
        ...
        def add_connectivity_filter(index, filter):
            ...
            infra_rsconnports = RsConnPortS(infra_connnodes, 'uni/infra/funcprof/accl-'+group_name+'/rsattEntP/hports-selector'+str(filter['switch_id'])+'LeafPorts-typ-range')
            id = 0
...
class CreatevPcInterfacePolicyGroup(CreateMo):
    ...
    def __init__(self):
        ...
        self.group = None
        super(CreatevPcInterfacePolicyGroup, self).__init__()

    def set_cli_mode(self):
        super(CreatevPcInterfacePolicyGroup, self).set_cli_mode()
    ...
    def run_cli_mode(self):
        super(CreatevPcInterfacePolicyGroup, self).run_cli_mode()
    ...
    def delete_mo(self):
        ...
        super(CreatevPcInterfacePolicyGroup, self).delete_mo()
...
if __name__ == '__main__':
    mo = CreatevPcInterfacePolicyGroup()
